        ...
        if (searchFormData.tipoBusca === "state") {
          ...
          if (searchFormData.estados.length === 0) {
            ...
            searchResults = allItems.filter(item =>
              searchFormData.estados.includes((item.state || '').toLowerCase())
            );
          }
        } else {
              ...
              <form onSubmit={handleSearchSubmit}>
                <div className="form-group">
                  ...
                  >
                    ...
                    <option value="state">Estado</option> {/* NOVO */}
                  </select>
                </div>
                <div className="form-group">
                  ...
                  {searchFormData.tipoBusca === "state" ? (
                    ...
                    >
                      ...
                      <option value="sem plaqueta">Sem plaqueta</option>
                    </select>
                  ) : (
                    <input 
                      type="text" 
